...
process prepareInput{
    ...
    """
        ...
        sed -i '1s/.*/${params.hamiltonian} B3LYP BASIS=${params.basis} cutoff=1.0e-10 denserms=1.0e-6  zmake GRADIENT DIPOLE OPTIMIZE EXPORT=MOLDEN/' ${input.simpleName}_prep.xyz 
    """
}
